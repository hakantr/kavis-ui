...
description: Kavis UI project style guide based on kavis-ui code patterns. Use when writing new components, reviewing code, or ensuring consistency with existing kavis-ui implementations. Covers component structure, trait implementations, naming conventions, and API patterns observed in the actual codebase.
---

## Overview

Code style guide derived from kavis-ui implementation patterns.
