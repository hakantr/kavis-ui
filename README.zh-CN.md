...
我们基于 Kavis UI 构建的商业应用：[Longbridge Pro](https://longbridge.com/desktop)。
...
Kavis UI 提供了 `Icon` 元素，但默认不包含 SVG 文件。

示例使用 [Lucide](https://lucide.dev) 图标，但你可以使用任意喜欢的图标。只需按照 [IconName](https://github.com/hakantr/kavis-ui/blob/main/crates/ui/src/icon.rs#L86) 中的定义命名 SVG 文件，然后将所需图标添加到项目中即可。
