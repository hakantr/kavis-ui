...
```rust
use kavis_ui::dialog::{AlertDialog, DialogAction, DialogClose};
use kavis_ui::WindowExt;
```
...
```rust
use kavis_ui::dialog::{AlertDialog, DialogHeader, DialogTitle, DialogDescription, DialogFooter};
...
```rust
use kavis_ui::dialog::DialogButtonProps;
use kavis_ui::button::ButtonVariant;
...
```rust
use kavis_ui::{Icon, IconName, ActiveTheme};
...
[AlertDialog]: https://docs.rs/kavis-ui/latest/kavis_ui/dialog/struct.AlertDialog.html
[Dialog]: https://docs.rs/kavis-ui/latest/kavis_ui/dialog/struct.Dialog.html
[DialogHeader]: https://docs.rs/kavis-ui/latest/kavis_ui/dialog/struct.DialogHeader.html
[DialogTitle]: https://docs.rs/kavis-ui/latest/kavis_ui/dialog/struct.DialogTitle.html
[DialogDescription]: https://docs.rs/kavis-ui/latest/kavis_ui/dialog/struct.DialogDescription.html
[DialogFooter]: https://docs.rs/kavis-ui/latest/kavis_ui/dialog/struct.DialogFooter.html
[DialogAction]: https://docs.rs/kavis-ui/latest/kavis_ui/dialog/struct.DialogAction.html
[DialogClose]: https://docs.rs/kavis-ui/latest/kavis_ui/dialog/struct.DialogClose.html
