...
```rust
use kavis_ui::description_list::{DescriptionList, DescriptionItem, DescriptionText};
```
...
DescriptionList::new()
    .children([
        DescriptionItem::new("Name").value("Kavis UI"),
...
DescriptionList::horizontal()
    ...
    .item("Repository", "https://github.com/hakantr/kavis-ui", 1)
...
DescriptionList::new()
    .columns(3)
    .child(DescriptionItem::new("Name").value("Kavis UI").span(1))
    .children([
        ...
        DescriptionItem::new("Repository")
            .value("https://github.com/hakantr/kavis-ui")
            .span(2),
    ])
```
...
DescriptionList::new()
    ...
    .children([
        DescriptionItem::new("Project Name").value("Kavis UI").span(1),
        DescriptionItem::new("Version").value("0.1.0").span(1),
