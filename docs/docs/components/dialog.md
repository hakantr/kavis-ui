...
The [Root::render_dialog_layer](https://docs.rs/kavis-ui/latest/kavis_ui/struct.Root.html#method.render_dialog_layer) function handles rendering any active dialogs on top of your app content.

```rust
use kavis_ui::TitleBar;
...
```rust
use kavis_ui::dialog::DialogContent;
