...
```rust
use kavis_ui::menu::ContextMenuExt;
...
```rust
use kavis_ui::popup_menu::{PopupMenuExt as _, PopupMenuItem};
...
Button::new("menu-btn")
    ...
    .dropdown_menu(|menu, window, cx| {
        menu.menu("New File", Box::new(NewFile))
            ...
            .link("Documentation", "https://hakantr.github.io/kavis-ui/")
            .separator()
...
```rust
use kavis_ui::{menu::PopupMenuItem, Button};
...
[PopupMenu]: https://docs.rs/kavis-ui/latest/kavis_ui/menu/struct.PopupMenu.html
[PopupMenuItem]: https://docs.rs/kavis-ui/latest/kavis_ui/menu/struct.PopupMenuItem.html
[context_menu]: https://docs.rs/kavis-ui/latest/kavis_ui/menu/trait.ContextMenuExt.html#method.context_menu
