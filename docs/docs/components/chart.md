...
```rust
use kavis_ui::chart::{LineChart, BarChart, AreaChart, PieChart, CandlestickChart};
```
...
`BarAlignment` controls the bar orientation and the side where the baseline sits. Import it from `kavis_ui::plot::shape`.

```rust
use kavis_ui::plot::shape::BarAlignment;
...
[LineChart]: https://docs.rs/kavis-ui/latest/kavis_ui/chart/struct.LineChart.html
[BarChart]: https://docs.rs/kavis-ui/latest/kavis_ui/chart/struct.BarChart.html
[AreaChart]: https://docs.rs/kavis-ui/latest/kavis_ui/chart/struct.AreaChart.html
[PieChart]: https://docs.rs/kavis-ui/latest/kavis_ui/chart/struct.PieChart.html
[CandlestickChart]: https://docs.rs/kavis-ui/latest/kavis_ui/chart/struct.CandlestickChart.html
