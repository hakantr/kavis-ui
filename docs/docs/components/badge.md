...
There is a default maximum count of `99`, any count above this will be displayed as `99+`. You can customize this maximum using the [max](https://docs.rs/kavis-ui/latest/kavis_ui/badge/struct.Badge.html#method.max) method.
...
[Badge]: https://docs.rs/kavis_ui/latest/kavis_ui/badge/struct.Badge.html
