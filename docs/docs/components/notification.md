...
The [Root::render_notification_layer](https://docs.rs/kavis-ui/latest/kavis_ui/struct.Root.html#method.render_notification_layer) function handles rendering any active modals on top of your app content.

```rust
use kavis_ui::{TitleBar, Root};
