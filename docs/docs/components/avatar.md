...
```rust
use kavis_ui::avatar::{Avatar, AvatarGroup};
```
...
[Avatar]: https://docs.rs/kavis-ui/latest/kavis_ui/avatar/struct.Avatar.html
[AvatarGroup]: https://docs.rs/kavis-ui/latest/kavis_ui/avatar/struct.AvatarGroup.html
