...
```rust
use kavis_ui::setting::{Settings, SettingPage, SettingGroup, SettingItem, SettingField};
```
...
```rust
use kavis_ui::group_box::GroupBoxVariant;
...
```rust
use kavis_ui::text::markdown;

SettingItem::new(
    "Documentation",
    SettingField::element(...)
)
.description(markdown("Rust doc for the `kavis-ui` crate."))
```
...
```rust
use kavis_ui::setting::NumberFieldOptions;
...
```rust
use kavis_ui::setting::{SettingFieldElement, RenderOptions};
...
SettingItem::new(
    ...
    SettingField::element(OpenURLSettingField {
        ...
        url: "https://github.com/hakantr/kavis-ui".into(),
    })
)
```
...
[Settings]: https://docs.rs/kavis-ui/latest/kavis_ui/setting/struct.Settings.html
[SettingPage]: https://docs.rs/kavis-ui/latest/kavis_ui/setting/struct.SettingPage.html
[SettingGroup]: https://docs.rs/kavis-ui/latest/kavis_ui/setting/struct.SettingGroup.html
[SettingItem]: https://docs.rs/kavis-ui/latest/kavis_ui/setting/struct.SettingItem.html
[SettingField]: https://docs.rs/kavis-ui/latest/kavis_ui/setting/enum.SettingField.html
[SettingFieldElement]: https://docs.rs/kavis-ui/latest/kavis_ui/setting/trait.SettingFieldElement.html
[NumberFieldOptions]: https://docs.rs/kavis-ui/latest/kavis_ui/setting/struct.NumberFieldOptions.html
