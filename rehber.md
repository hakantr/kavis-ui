...
- `workspace::open_paths(paths, app_state, requesting_window, cx)`: standalone
  helper; gerekirse pencere açar.
...
- `Workspace::open_path_preview(...)`: file finder gibi ön izleme akışları için.
