...
/// Bir cubic bezier fonksiyon gibi CSS `cubic-bezier`.
///
/// Oluşturucu:
///
...
/// Kübik çıkış yumuşaması: hızlı başlangıç, yavaş bitiş. Giriş animasyonları için uygundur.
pub fn ease_out_cubic(t: f32) -> f32 {
    let t = t.clamp(0.0, 1.0);
    1.0 - (1.0 - t).powi(3)
}

/// Kübik giriş yumuşaması: yavaş başlangıç, hızlı bitiş. Çıkış animasyonları için uygundur.
pub fn ease_in_cubic(t: f32) -> f32 {
    let t = t.clamp(0.0, 1.0);
    t * t * t
}

/// Kübik giriş-çıkış yumuşaması: yavaş başlangıç ve bitiş. Konum geçişleri için uygundur.
...
/// Doğrusal enterpolasyonu destekleyen tipler için trait.
...
/// Animasyonlu stil değişikliklerini tanımlayan bileştirilebilir geçiş.
///
/// # Örnek
///
/// ```ignore
