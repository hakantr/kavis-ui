...
use crate::{
    ...
    input::{self, Copy},
    text::{
        CodeBlockActionsFn, MetinGorunumuStili,
...
const CONTEXT: &'static str = "MetinGorunumu";
...
/// durum bir MetinGorunumu.
pub struct MetinGorunumuDurumu {
    pub(super) focus_handle: FocusHandle,
    pub(super) list_state: ListeDurumu,

    /// sınırlar metin görünüm
    bounds: Bounds<Pixels>,

    pub(super) selectable: bool,
    pub(super) scrollable: bool,
    pub(super) text_view_style: MetinGorunumuStili,
    pub(super) code_block_actions: Option<std::sync::Arc<CodeBlockActionsFn>>,

    pub(super) is_selecting: bool,
    /// yerel (içinde MetinGorunumu) konum seçim.
...
impl MetinGorunumuDurumu {
    ...
    /// Metnin seçilebilir olup olmadığını ayarlar. Varsayılan false değeridir.
    ...
    /// Append partial metin içerik için existing metin.
    ...
    /// Save sınırlar ve unselect ise sınırlar değişmiş.
    ...
    /// Seçim başlangıç/bitiş noktalarını pencere koordinatlarında döndürür.
...
impl Render for MetinGorunumuDurumu {
...
struct UpdateOptions {
    ...
    pending_text: String,
    append: bool,
    highlight_theme: std::sync::Arc<VurguTemasi>,
}
