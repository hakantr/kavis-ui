...
#[derive(IntoElement)]
pub(super) struct AdimlayiciTetikleyicisi {
    step: usize,
    checked_step: usize,
...
impl AdimlayiciTetikleyicisi {
    ...
    pub(super) fn icon(mut self, icon: Option<impl Into<Simge>>) -> Self {
...
impl Styled for AdimlayiciTetikleyicisi {
    fn style(&mut self) -> &mut StyleRefinement {
        &mut self.style
    }
}

impl ParentElement for AdimlayiciTetikleyicisi {
    fn extend(&mut self, elements: impl IntoIterator<Item = AnyElement>) {
        self.children.extend(elements);
    }
}

impl RenderOnce for AdimlayiciTetikleyicisi {
