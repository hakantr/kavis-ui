...
impl MenuItemElement {
    /// Yeni bir MenuItem ile verilen ID ve grup ad oluşturur.
    ...
    /// devre dışı durum MenuItem ayarlar.
    pub(crate) fn disabled(mut self, disabled: bool) -> Self {
        self.disabled = disabled;
        self
    }

    /// MenuItem tıklandığında çağrılacak işleyiciyi ayarlar.
    ...
    /// bir işleyici için olduğunda fare enters MenuItem ayarlar.
    #[allow(unused)]
