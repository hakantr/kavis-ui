...
///
/// Fare tekerleği kaydırıldığında `scroll_handle` değerini `axis` yönünde taşır.
/// Siz kullanabilir bu `scroll_handle` için kontrol what siz isterseniz için kaydırma.
/// Bu, her seferinde yalnızca tek eksende kaydırmayı işleyebilir.
pub struct KaydirilabilirMaske {
    axis: Axis,
    scroll_handle: ScrollHandle,
    debug: Option<Hsla>,
}

impl KaydirilabilirMaske {
    /// Yeni bir scrollable maske öğe oluşturur.
...
impl IntoElement for KaydirilabilirMaske {
    type Element = Self;
...
impl Element for KaydirilabilirMaske {
