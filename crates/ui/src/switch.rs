...
/// Açık veya kapalı duruma getirilebilen bir Anahtar öğesi.
#[derive(IntoElement)]
pub struct Anahtar {
    id: ElementId,
...
impl Anahtar {
    /// Yeni bir Anahtar öğe oluşturur.
    ...
    /// Switch öğesinin işaretli durumunu ayarlar.
    pub fn checked(mut self, checked: bool) -> Self {
        self.checked = checked;
        self
    }

    /// etiket switch ayarlar.
    pub fn label(mut self, label: impl Into<Text>) -> Self {
        self.label = Some(label.into());
        self
    }

    /// Bir tıklama işleyici için switch ekler.
    ...
    /// Switch işaretliyken kullanılacak arka plan rengini ayarlar.
    /// Defaults için `cx.theme().primary`.
    pub fn color(mut self, color: impl Into<Hsla>) -> Self {
        self.color = Some(color.into());
        self
    }

    /// araç ipucu metin için switch ayarlar.
