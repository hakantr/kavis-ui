...
impl<T> PieChart<T> {
    ...
    /// inner yarıçap pasta grafik ayarlar.
    pub fn inner_radius(mut self, inner_radius: f32) -> Self {
        self.inner_radius = inner_radius;
        self
    }

    /// inner yarıçap pasta grafik temelli üzerinde yay veri ayarlar.
    ...
    /// outer yarıçap pasta grafik ayarlar.
    pub fn outer_radius(mut self, outer_radius: f32) -> Self {
        self.outer_radius = outer_radius;
        self
    }

    /// outer yarıçap pasta grafik temelli üzerinde yay veri ayarlar.
