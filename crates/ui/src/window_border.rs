...
/// Yeni bir pencere kenarlık oluşturur.
pub fn window_border() -> PencereKenarligi {
    PencereKenarligi::new()
}

/// Pencere kenarlık kullanmak çizmek için özel pencere kenarlık ve gölge için Linux.
#[derive(IntoElement)]
pub struct PencereKenarligi {
    shadow_size: Pixels,
    children: Vec<AnyElement>,
}

impl Default for PencereKenarligi {
    fn default() -> Self {
        Self {
...
impl PencereKenarligi {
    pub fn new() -> Self {
        Self::default()
    }

    /// gölge boyut için typical Linux client-taraf decorations ayarlar.
    ///
    /// varsayılan: [`SHADOW_SIZE`]
...
impl ParentElement for PencereKenarligi {
    fn extend(&mut self, elements: impl IntoIterator<Item = AnyElement>) {
        self.children.extend(elements);
    }
}

impl RenderOnce for PencereKenarligi {
