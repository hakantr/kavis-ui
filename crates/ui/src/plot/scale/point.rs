...
/// Nokta ölçek maps discrete domain değerler için continuous aralık positions.
///
/// Noktalar aralık boyunca eşit dağıtılır; ilk ve son noktalar
/// aligned için aralık boundaries.
#[derive(Clone)]
...
where
    T: PartialEq,
{
    /// Yeni bir nokta ölçek ile verilen domain ve aralık oluşturur.
    ///
    /// # Örnekler
    ///
    /// ```ignore
