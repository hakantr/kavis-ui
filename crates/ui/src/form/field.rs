...
pub struct Field {
    ...
    /// İçin kullanılır çizer gerçek form alan, e.g.: girdi, Anahtar.
...
impl Field {
    ...
    /// etiket için form alan ayarlar.
    pub fn label(mut self, label: impl Into<FieldBuilder>) -> Self {
        self.label = Some(label.into());
        self
    }

    /// Yatay yerleşimde etiket genişliği kadar girinti kullanılıp kullanılmayacağını ayarlar. Varsayılan `true`.
    ///
    /// Bazen form girdisini sola hizalamak istersiniz; yatay yerleşimde varsayılan hizalama etiket genişliğinden sonradır.
    ///
    /// Bu yalnızca `etiket` ayarlanmadığında çalışır.
    pub fn label_indent(mut self, indent: bool) -> Self {
        self.label_indent = indent;
        self
    }

    /// etiket için form alan kullanarak bir fonksiyon ayarlar.
    ...
    /// açıklama için form alan ayarlar.
    pub fn description(mut self, description: impl Into<FieldBuilder>) -> Self {
        self.description = Some(description.into());
        self
    }

    /// açıklama için form alan kullanarak bir fonksiyon ayarlar.
    ...
    /// Form alanının görünürlüğünü ayarlar. Varsayılan `true` değeridir.
    pub fn visible(mut self, visible: bool) -> Self {
        self.visible = visible;
        self
    }

    /// Form alanının gerekli durumunu ayarlar. Varsayılan `false`.
    pub fn required(mut self, required: bool) -> Self {
        self.required = required;
        self
    }

    /// Form alanı özelliklerini ayarlar.
    ///
    /// Bu dahili API, özellikleri Den değerinden eşitler.
    ...
    /// Form alanı öğelerini başlangıca hizalar; varsayılan budur.
    pub fn items_start(mut self) -> Self {
        self.align_items = Some(AlignItems::Start);
        self
    }

    /// Align form alan öğeler için bitiş.
    pub fn items_end(mut self) -> Self {
        self.align_items = Some(AlignItems::End);
        self
    }

    /// Form alanı öğelerini ortaya hizalar.
    pub fn items_center(mut self) -> Self {
        self.align_items = Some(AlignItems::Center);
        self
    }

    /// Form alanının kaç sütuna yayılacağını ayarlar.
    ///
    /// varsayılandır 1.
...
impl RenderOnce for Field {
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(
                // This warp for aligning the Etiket + Input
                wrap_div(layout)
                    .id(self.id)
                    .gap(inner_gap)
