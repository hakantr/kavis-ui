...
use crate::ham_gpui::{App, Pixels, Size};
...
pub(crate) struct RowsCache {
    /// Yalnızca sahip bölüm's olan sahip satırlar.
    pub(crate) entities: Rc<Vec<RowEntry>>,
    pub(crate) items_count: usize,
    /// Bölümler; her bölümdeki satır sayısını içerir.
...
impl RowsCache {
    ...
    /// sayı flattened satırlar (Includes başlık, öğe, alt bilgi) döndürür.
    pub(crate) fn len(&self) -> usize {
        self.entities.len()
    }

    /// sayı öğeler içinde önbellek döndürür.
    pub(crate) fn items_count(&self) -> usize {
        self.items_count
    }

    /// indeks Entry ile verilen yol içinde flattened satırlar döndürür.
    ...
    /// Önceki satırı döndürür; satır ilk bölümdeki ilk satırsa son satıra gider.
    ///
    /// Boş satır bölümleri atlanır.
    ...
    /// Sonraki satırı döndürür; satır son bölümdeki son satırsa ilk satıra gider.
    ///
    /// Boş satır bölümleri atlanır.
