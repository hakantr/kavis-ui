...
use crate::ham_gpui::{Context, Window};
use ropey::Rope;
use sum_tree::Bias;
...
enum CharType {
    ...
    /// \n, \r
    Newline,
    /// ., ; : ( ) [ ] { }. veya CJK karakterler: `汉`, `🎉` etc.
    Other,
}

/// uygulama temelli üzerinde <https://github.com/zed-industries/zed/blob/ana/crates/gpui/src/text_system/line_wrapper.rs>
...
impl CharType {
    /// İki CharTypes değerinin bağlanabilir olup olmadığını kontrol eder.
...
impl InputState {
    /// Verilen ofsette çift tıklama ile kelime seçer.
    ///
    ...
    /// Verilen ofsette üçlü tıklama ile satır seçer.
    ///
    /// Ofset UTF-8 ofsetidir.
...
struct TextSelector;
impl TextSelector {
    /// Verilen metinde belirtilen ofsetteki satırı seçer.
    ///
    /// Ofset UTF-8 ofsetidir.
    ///
    /// başlangıç ve bitiş offsets seçili satır döndürür.
    ...
    /// Verilen metinde belirtilen ofsetteki kelimeyi seçer.
    ///
    /// Ofset UTF-8 ofsetidir.
    ///
    /// başlangıç ve bitiş offsets seçili kelime döndürür.
