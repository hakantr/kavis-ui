...
/// Üzerine gelme sağlayıcısı
///
/// https://microsoft.github.io/dil-server-protocol/specifications/lsp/3.17/specification/#textDocument_hover
pub trait HoverProvider {
    /// textDocument/üzerine gelme
    ///
    /// https://microsoft.github.io/dil-server-protocol/specifications/lsp/3.17/specification/#textDocument_hover
    fn hover(
        &self,
...
impl InputState {
    /// İşler üzerine gelme tetikleyici LSP istek.
