...
/// Tanım sağlayıcısı
///
/// https://microsoft.github.io/dil-server-protocol/specifications/lsp/3.17/specification/#textDocument_definition
...
pub(crate) struct HoverDefinition {
    /// Üzerine gelmeyi tetikleyen sembolün aralığı.
