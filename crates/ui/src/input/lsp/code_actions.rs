...
pub trait CodeActionProvider {
    /// id için bu CodeAction.
    fn id(&self) -> SharedString;

    /// Fetches kod eylemler için belirtilen aralık.
    ///
    /// textDocument/codeAction
    ///
    /// https://microsoft.github.io/dil-server-protocol/specifications/lsp/3.17/specification/#textDocument_codeAction
    fn code_actions(
        &self,
...
impl InputState {
    ...
    /// Gösterir kod eylemler için imleç.
