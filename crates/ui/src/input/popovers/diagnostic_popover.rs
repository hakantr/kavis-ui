...
use crate::{
    highlighter::TaniGirdisi,
    input::{
        InputState,
        popovers::{AcilirKatman, render_markdown},
    },
};

pub struct DiagnosticPopover {
    state: Entity<InputState>,
    pub(crate) diagnostic: Rc<TaniGirdisi>,
    bounds: Bounds<Pixels>,
    open: bool,
}

impl DiagnosticPopover {
    pub fn new(diagnostic: &TaniGirdisi, state: Entity<InputState>, cx: &mut App) -> Entity<Self> {
