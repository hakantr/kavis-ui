...
pub struct HoverPopover {
    ...
    /// symbol aralık bayt üzerine gelme tetikleyici.
...
impl AcilirKatman {
    ...
    /// Düzenleyicide görünürse sınır aralığını döndürür.
...
impl IntoElement for AcilirKatman {
    type Element = Self;
