...
impl InputState {
    /// İmleç taşındıktan sonra çağrılır. İmlecin yeni konumu biliniyorsa preferred_column değerini günceller.
    ...
    /// Taşır imleç için verilen ofset.
    ///
    ...
    /// İmleci mümkünse sütunu koruyarak bir satır yukarı veya aşağı taşır.
    ///
    /// move_lines: Sayı satırlar için taşıma vertically (positive için down, negative için up).
