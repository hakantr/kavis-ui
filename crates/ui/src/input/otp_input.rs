...
pub struct OtpState {
    ...
    masked: bool,
    length: usize,
    // Shadow InputState written into KokGorunum::focused_input while this OTP has focus.
...
impl OtpState {
    /// Yeni bir [`OtpState`] ile belirtilen uzunluk oluşturur.
    ...
    /// varsayılan değer OTP girdi ayarlar.
    pub fn default_value(mut self, value: impl Into<SharedString>) -> Self {
        self.value = value.into();
        self
    }

    /// değer OTP girdi ayarlar.
    pub fn set_value(
        &mut self,
    ...
    /// değer OTP girdi döndürür.
    pub fn value(&self) -> &SharedString {
        &self.value
    }

    /// maskelenmiş için true kullanım maskelenmiş girdi ayarlar.
    ...
    /// Try için çıkarır bir ASCII digit char bir metin.
    /// Supports ikisi de half-genişlik ('0'-'9') ve tam-genişlik ('0'-'9') digits.
...
/// Bir One Time Password (OTP) girdi öğe.
///
/// Sabit uzunlukta sayı kabul edebilir ve maskelenebilir.
///
/// Kullanım case örnek:
///
/// - SMS OTP
...
impl OtpInput {
    /// Yeni bir [`OtpInput`] öğe bind için [`OtpState`] oluşturur.
    ...
    /// sayı gruplar içinde OTP girdi ayarlar.
