...
/// BaslikCubugu için kullanılır customize görünüm başlık çubuk.
///
/// Başlık çubuğuna bazı öğeler yerleştirebiliriz.
#[derive(IntoElement)]
pub struct BaslikCubugu {
...
impl BaslikCubugu {
    /// Yeni bir BaslikCubugu oluşturur.
    pub fn new() -> Self {
        Self {
    ...
    /// [`crate::BaslikCubugu`] ile uyumlu varsayılan başlık çubuğu seçeneklerini döndürür.
    ...
    /// Özel pencere kapatma olayı ekler. Varsayılan None; bu durumda X düğmesine tıklamak `window.remove_window()` çağırır.
    /// Yalnızca Linux için geçerlidir; diğer platformlarda işlem yapmaz.
...
impl ControlIcon {
    ...
    fn icon(&self) -> SimgeAdi {
        match self {
            Self::Minimize => SimgeAdi::WindowMinimize,
            Self::Restore => SimgeAdi::WindowRestore,
            Self::Maximize => SimgeAdi::WindowMaximize,
            Self::Close { .. } => SimgeAdi::WindowClose,
        }
    }
...
impl RenderOnce for ControlIcon {
    fn render(self, _: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        div()
            ...
            .child(Simge::new(self.icon()).small())
    }
}
...
impl ParentElement for BaslikCubugu {
...
impl RenderOnce for BaslikCubugu {
