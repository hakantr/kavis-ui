...
/// Yeniden boyutlandırılabilir panel için bir yeniden boyutlandırma işleyicisi oluşturur.
...
pub(crate) struct ResizeHandle<T: 'static, E: 'static + Render> {
    ...
    placement: Option<YerlesimKonumu>,
...
impl<T: 'static, E: 'static + Render> ResizeHandle<T, E> {
    ...
    pub(crate) fn placement(mut self, placement: YerlesimKonumu) -> Self {
        ...
        window.with_element_state(id.unwrap(), |state, window| {
            ...
            let mut el = div()
                ...
                .map(|this| match self.placement {
                    Some(YerlesimKonumu::Left) => {
                        // Special for Left Yerlesim
