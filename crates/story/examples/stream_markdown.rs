...
use kavis_ui::{
    button::Dugme,
    h_flex,
    text::{MetinGorunumu, MetinGorunumuDurumu},
    v_flex,
};
...
pub struct Example {
    markdown_state: Entity<MetinGorunumuDurumu>,
...
impl Example {
    pub fn new(_: &mut Window, cx: &mut Context<Self>) -> Self {
        let markdown_state =
            cx.new(|cx| MetinGorunumuDurumu::markdown("# Streaming Markdown Parse\n\n", cx));
    ...
    /// Markdown durumunu parçalar halinde güncelleyerek akışı simüle eder
    /// Her yineleme 50 ms sürer ve her seferinde yaklaşık 5 - 20 karakter eklenir
    /// Bu yalnızca gösterim amaçlıdır; gerçek bir uygulamada bir kaynaktan akış yapılır.
        ...
        v_flex()
            ...
            .child(
                div()
                    ...
                    .overflow_y_scroll()
                    .size_full()
                    .child(MetinGorunumu::new(&self.markdown_state).selectable(true)),
            )
    }
}
