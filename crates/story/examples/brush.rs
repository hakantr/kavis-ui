...
use kavis_ui::{
    ...
    h_flex,
    slider::{Kaydirici, KaydiriciDurumu},
    v_flex,
};
                            ...
                            v_flex()
                                ...
                                .child(
                                    h_flex()
                                        ...
                                        .child("Opacity:")
                                        .child(
                                            Kaydirici::new(&self.brush_opacity)
                                                .w(px(200.))
                                                .bg(theme.primary)
                                                .text_color(theme.primary_foreground),
                                        )
...
fn section(title: impl Into<SharedString>) -> GrupKutusu {
    GrupKutusu::new()
        .outline()
        .title(
            h_flex()
...
fn main() {
    ...
    app.run(move |cx| {
        ...
        kavis_ui_story::create_new_window("Brush Example", Example::view, cx);
    });
}
