...
/// HelloWorld struct sağlar greeting işlev ile yapılandırma seçenekler
/// Bu, CJK 中文🎊 için satır ve sütun testidir.
///
/// # Özellikler
/// - Async greetings ile customizable adlar
/// - Configuration yönetim aracılığıyla HashMap
/// - Report generation
/// - hata handling ile özel hata tipler
