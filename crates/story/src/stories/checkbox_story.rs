...
impl Render for CheckboxStory {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        v_flex()
            ...
            .child(
                section("Without label").child(OnayKutusu::new("3").checked(self.check3).on_click(
            ...
            .child(
                section("Large size").max_w_md().child(
                    OnayKutusu::new("check5")
                        .large()
                        .checked(self.check2)
                        .label("Büyük onay kutusu")
                        .on_click(cx.listener(|this, checked: &bool, _, _| {
                            this.check2 = *checked;
                        })),
                ),
            ...
            .child(
                section("Disabled").max_w_md().child(
                    h_flex()
                        ...
                        .gap_6()
                        .child(
                            OnayKutusu::new("check3")
                                .label("Seçiliyken devre dışı")
                                .checked(true)
                                .disabled(true),
                        )
                        .child(
                            OnayKutusu::new("check3_1")
                                .label("Seçili değilken devre dışı")
                                .checked(false)
                                .disabled(true),
                        ),
                ),
            ...
            .child(
                section("Multi-line").child(
                    v_flex().gap_4().child(
                        OnayKutusu::new("multi-line-checkbox")
                            .w(px(300.))
                            .checked(self.check4)
                            .label("Çok satırlı onay kutusu.")
                ...
                section("Etiket wrapping").child(
                    v_flex().gap_4().child(
                        div()
                            ...
                            .child(
                                OnayKutusu::new("label-wrap-checkbox")
                                    .checked(self.check6)
                                    .label(
            ...
            .child(
                section("Rich description (Markdown)").child(
                    OnayKutusu::new("longlong-markdown-checkbox")
                        .w(px(300.))
                        .checked(self.check5)
                        .label("Açıklamalı etiket (Markdown)")
                        .child(
                            div()
