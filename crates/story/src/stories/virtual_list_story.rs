...
use kavis_ui::{
    ...
    divider::Ayirici,
    h_flex,
    scroll::{KaydirilabilirOge, KaydirmaCubuguEkseni},
...
impl VirtualListStory {
    ...
    pub fn change_axis(&mut self, axis: KaydirmaCubuguEkseni, cx: &mut Context<Self>) {
        self.axis = axis;
        cx.notify();
    }
                ...
                h_flex()
                    ...
                    .child(
                        h_flex()
                            ...
                            .child(Ayirici::vertical().px_2())
                            .child(
                                DugmeGrubu::new("scrollbars")
                                    .outline()
                                    .compact()
                                    .child(
                                        Dugme::new("test-axis-both")
                                            .label("Both KaydirmaCubugu")
                                    ...
                                    .on_click(cx.listener(|view, clicks: &Vec<usize>, _, cx| {
                                        if clicks.contains(&0) {
                                            view.change_axis(KaydirmaCubuguEkseni::Both, cx)
                                        } else if clicks.contains(&1) {
                                            view.change_axis(KaydirmaCubuguEkseni::Vertical, cx)
                                        } else if clicks.contains(&2) {
                                            view.change_axis(KaydirmaCubuguEkseni::Horizontal, cx)
                                        }
                                    })),
                            ),
                    )
