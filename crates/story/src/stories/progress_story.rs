...
impl Render for ProgressStory {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(
                        h_flex()
                            .gap_2()
                            .child(Dugme::new("button-1").small().label("0%").on_click(
                                cx.listener(|this, _, _, _| {
                                    this.set_value(0.);
                                }),
                            ))
                            .child(Dugme::new("button-2").small().label("25%").on_click(
                                cx.listener(|this, _, _, _| {
                                    this.set_value(25.);
                                }),
                            ))
                            .child(Dugme::new("button-3").small().label("75%").on_click(
                                cx.listener(|this, _, _, _| {
                                    this.set_value(75.);
                                }),
                            ))
                            .child(Dugme::new("button-4").small().label("100%").on_click(
                                cx.listener(|this, _, _, _| {
                                    this.set_value(100.);
                                }),
                            ))
                            .child(
                                Dugme::new("circle-animation-button")
                                    .small()
                                    .icon(SimgeAdi::Play)
                    ...
                    .child(
                        h_flex()
                            .gap_2()
                            .child(
                                Dugme::new("circle-button-5")
                                    .icon(SimgeAdi::Minus)
                                    .on_click(cx.listener(|this, _, _, _| {
                                        this.set_value((this.value - 1.).max(0.));
                                    })),
                            )
                            .child(Dugme::new("circle-button-6").icon(SimgeAdi::Plus).on_click(
                                cx.listener(|this, _, _, _| {
            ...
            .child(
                section("Ilerleme Bar").max_w_md().child(
                    Ilerleme::new("progress-1")
                        .value(self.value)
            ...
            .child(
                section("Circle Ilerleme").max_w_md().child(
                        ...
                        .when(!self.loading, |this| {
                            this.child(
                                v_flex()
                                    ...
                                    .child(div().child("Yükleniyor").text_xs()),
                            )
                        }),
                ),
            )
            .child(
                section("With size").max_w_md().child(
                    h_flex()
                        .gap_2()
                        .child(
                            DaireselIlerleme::new("circle-progress-2")
                                .value(self.value)
                                .loading(self.loading)
                                .large(),
                        )
                        .child(
                            DaireselIlerleme::new("circle-progress-3")
                                .value(self.value)
                                .loading(self.loading),
                        )
                        .child(
                            DaireselIlerleme::new("circle-progress-4")
                                .value(self.value)
                                .loading(self.loading)
                                .small(),
                        )
                        .child(
                            DaireselIlerleme::new("circle-progress-5")
                                .value(self.value)
                                .loading(self.loading)
                                .xsmall(),
                        ),
            ...
            .child(
                section("With Etiket").max_w_md().child(
                    h_flex()
                        .gap_2()
                        .child(
                            DaireselIlerleme::new("circle-progress-6")
            ...
            .child(
                section("Circle with Color").max_w_md().child(
                    DaireselIlerleme::new("circle-progress-7")
