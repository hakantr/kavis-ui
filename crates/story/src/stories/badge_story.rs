...
use kavis_ui::{
    EtkinTema as _, Simge, SimgeAdi, Sizable as _, avatar::Avatar, badge::Rozet,
...
impl Render for BadgeStory {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        v_flex()
            .gap_4()
            .child(
                section("Rozet on icon")
                    .max_w_md()
                    .child(
                        Rozet::new()
                            .count(3)
                            .child(Simge::new(SimgeAdi::Bell).large()),
                    )
                    .child(
                        Rozet::new()
                            .count(103)
                            .child(Simge::new(SimgeAdi::Inbox).large()),
                    ),
            )
            .child(
                section("Rozet with count")
                    .max_w_md()
                    .child(Rozet::new().count(3).child(
                        Avatar::new().src("https://avatars.githubusercontent.com/u/5518?v=4"),
                    ))
                    .child(Rozet::new().count(103).child(
                        Avatar::new().src("https://avatars.githubusercontent.com/u/28998859?v=4"),
                    )),
            )
            .child(
                section("Rozet with icon")
                    .max_w_md()
                    .child(
                        Rozet::new()
                            .icon(SimgeAdi::Check)
            ...
            .child(
                section("Rozet with dot").max_w_md().child(
            ...
            .child(
                section("Rozet with color")
                    .max_w_md()
                    .child(Rozet::new().count(3).color(cx.theme().blue).child(
                        Avatar::new().src("https://avatars.githubusercontent.com/u/5518?v=4"),
                    ))
                    .child(Rozet::new().dot().color(cx.theme().green).count(1).child(
                        Avatar::new().src("https://avatars.githubusercontent.com/u/5518?v=4"),
                    )),
            )
            .child(
                section("Complex use")
                    .max_w_md()
                    .child(
                        Rozet::new().count(212).large().child(
                            Rozet::new()
                                .icon(SimgeAdi::Check)
                                .large()
                                .color(cx.theme().cyan)
                    ...
                    .child(
                        Rozet::new().count(2).color(cx.theme().green).large().child(
                            Rozet::new()
                                .icon(SimgeAdi::Star)
                                .large()
                                .color(cx.theme().yellow)
                    ...
                    .child(
                        Rozet::new().count(3).color(cx.theme().green).child(
                            Rozet::new()
