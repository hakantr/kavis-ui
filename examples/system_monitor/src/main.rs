...
use kavis_ui::{
    ...
    table::{Column, ColumnSort, TabloDurumu, TabloTemsilcisi, VeriTablosu},
    v_flex,
};
use smol::Timer;
...
/// Sistem metrikleri için tek bir veri noktası
#[derive(Clone)]
struct MetricPoint {
    time: String,
    cpu: f64,
...
impl TabloTemsilcisi for ProcessTableDelegate {
    ...
    fn perform_sort(
        ...
        sort: ColumnSort,
        _window: &mut Window,
        _cx: &mut Context<TabloDurumu<Self>>,
    ) {
...
/// Baytları insan tarafından okunabilir metne biçimlendirir
...
/// Gerçek zamanlı metrikleri toplayıp gösteren sistem izleyici
pub struct SystemMonitor {
    ...
    process_table: Entity<TabloDurumu<ProcessTableDelegate>>,
...
impl SystemMonitor {
    fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        ...
        let process_table = cx.new(|cx| {
            TabloDurumu::new(process_delegate, window, cx)
            ...
            && let Ok(batteries) = manager.batteries()
        {
            for battery in batteries.flatten() {
                let icon = match battery.state() {
                    battery::State::Charging => SimgeAdi::BatteryCharging,
                    battery::State::Discharging => SimgeAdi::BatteryMedium,
                    battery::State::Full => SimgeAdi::BatteryFull,
                    battery::State::Empty => SimgeAdi::Battery,
                    _ => SimgeAdi::Battery,
                };
    ...
    fn render_processes_tab(&self, _cx: &Context<Self>) -> impl IntoElement {
        v_flex().size_full().child(
            VeriTablosu::new(&self.process_table)
                .bordered(false)
                .stripe(true)
                .small(),
        )
                ...
                h_flex()
                    ...
                    .when_some(primary_disk, |this, disk| {
                        ...
                        this.child(
                            h_flex()
                                ...
                                .w(px(135.))
                                .items_center()
                                .child(Simge::new(SimgeAdi::HardDrive))
                                .child(
                                    Ilerleme::new("status-disk")
                                        .w_12()
                                        .h_2()
                                        .value(used_percent),
                                )
                    ...
                    .child({
                        ...
                        h_flex()
                            ...
                            .w(px(135.))
                            .items_center()
                            .child(Simge::new(SimgeAdi::MemoryStick))
                            .child(Ilerleme::new("status-mem").w_12().h_2().value(mem_percent))
                    ...
                    .child({
                        ...
                        h_flex()
                            ...
                            .w(px(135.))
                            .items_center()
                            .child(Simge::new(SimgeAdi::Cpu))
                            .child(Ilerleme::new("status-cpu").w_12().h_2().value(cpu_percent))
                ...
                div().when_some(primary_battery, |this, battery| {
                    this.child(
                        h_flex()
                            .gap_2()
                            .items_center()
                            .child(Simge::new(battery.icon.clone()))
                ...
                BaslikCubugu::new()
                    .child(
                        SekmeCubugu::new("monitor-tabs")
                            ...
                            .child(Sekme::new().label("System"))
                            .child(Sekme::new().label("Processes")),
                    )
                    .child(
                        div()
                            .mr_4()
    ...
    app.run(move |cx| {
        ...
        cx.spawn(async move |cx| {
            cx.open_window(window_options, |window, cx| {
                ...
                Tema::change(TemaModu::Dark, Some(window), cx);
