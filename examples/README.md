# Kavis UI basic examples

This folder contains basic examples of how to use the Kavis UI library. Each example demonstrates a specific feature or functionality of the library.
...
4. Following the code style and name style used in the existing examples or in entire of Kavis UI.
